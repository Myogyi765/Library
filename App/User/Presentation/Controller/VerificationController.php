...
class VerificationController extends BaseController
{
    ...
    public function __construct($container = null)
    {
        ...
        $this->verificationService = $this->container->get('verification.service');
    ...
    public function verifyEmail(): void
    {
        ...
        if (isset($_SESSION['just_registered']) && $_SESSION['just_registered'] === true) {
            ...
            $success = true;
            $this->view('verify', ['message' => $message, 'success' => $success, 'token' => $token]);
            return;
        }
        ...
        if (empty($token)) {
            ...
            $success = false;
            $this->view('verify', ['message' => $message, 'success' => $success, 'token' => '']);
            return;
        }
