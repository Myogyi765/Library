...
// ================================================================
// DEBUG & MEMORY (temporary – remove in production)
// ================================================================
...
<nav class="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-slate-800 dark:to-slate-900
    ...
    <div class="container mx-auto flex items-center justify-between">
            ...
            ?>
                ...
                <?php if ($showNotifications): ?>
                    ...
                    <div class="relative inline-block" id="notification-container">
                        <button id="notification-bell" class="nav-link-blue relative" title="Notifications">
                            <i class="fas fa-bell"></i>
                            <span id="notification-badge" class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full px-1.5 py-0.5 leading-none min-w-[20px] text-center hidden">0</span>
                        </button>
                        <div id="notification-dropdown" class="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 hidden z-50 max-h-96 overflow-y-auto">
                            <div class="p-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between sticky top-0 bg-white dark:bg-gray-800 z-10">
        ...
        <!-- Mobile Menu Toggle -->
        <button id="mobile-menu-button" class="md:hidden text-white text-xl p-2 hover:bg-white/10 rounded-lg transition">
    ...
    <div id="mobile-menu" class="hidden md:hidden mt-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-3 space-y-1">
        <a href="<?php echo BASE_URL; ?>/home" class="mobile-link-blue"><i class="fas fa-house"></i> Home</a>
        <a href="<?php echo BASE_URL; ?>/books" class="mobile-link-blue"><i class="fas fa-book-open"></i> Catalog</a>
        <?php if ($isLoggedIn): ?>
            ...
            <?php if ($showNotifications): ?>
                <div class="relative inline-block w-full">
                    <button id="mobile-notification-bell" class="mobile-link-blue w-full text-left">
                        <i class="fas fa-bell"></i> Notifications
                        <span id="mobile-notification-badge" class="ml-auto bg-red-500 text-white text-xs rounded-full px-2 py-0.5 hidden">0</span>
                    </button>
                </div>
            <?php endif; ?>
            <a href="<?php echo BASE_URL; ?>/logout"
        ...
        <?php else: ?>
            <a href="<?php echo BASE_URL; ?>/login" class="mobile-link-blue"><i class="fas fa-right-to-bracket"></i> Login</a>
            <a href="<?php echo BASE_URL; ?>/register" class="mobile-link-blue bg-white/20 text-white font-semibold rounded-lg"><i class="fas fa-user-plus"></i> Register Now</a>
        <?php endif; ?>
    </div>
</nav>
