    ...
    <div class="bg-white dark:bg-gray-900 min-h-screen transition-colors duration-300">
        ...
        <section class="container mx-auto py-8 px-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <?php foreach ($statsData as $stat): ?>
                <div class="group bg-white dark:bg-gray-800/80 rounded-lg shadow-sm hover:shadow-md transition-all hover:-translate-y-0.5 p-4 text-center border border-gray-200 dark:border-gray-700">
                    <div class="w-12 h-12 bg-<?php echo $stat['color']; ?>-100 dark:bg-<?php echo $stat['color']; ?>-900/30 rounded-full flex items-center justify-center mx-auto mb-2 group-hover:scale-105 transition">
                        <i class="fas <?php echo $stat['icon']; ?> text-xl text-<?php echo $stat['color']; ?>-600 dark:text-<?php echo $stat['color']; ?>-400"></i>
                    </div>
                    <h2 class="text-2xl font-bold text-<?php echo $stat['color']; ?>-600 dark:text-<?php echo $stat['color']; ?>-400">
                        <?php echo $stat['value']; ?>
                    </h2>
                    <p class="text-gray-600 dark:text-gray-400 text-xs font-medium"><?php echo $stat['label']; ?></p>
                </div>
            <?php endforeach; ?>
        </section>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    foreach ($features as $feature):
                        $color = $feature['color'];
                    ?>
                    <div class="bg-white dark:bg-gray-800/60 rounded-lg shadow-sm hover:shadow-md transition hover:-translate-y-0.5 p-4 text-center border border-gray-200 dark:border-gray-700">
