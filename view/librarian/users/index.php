...
<div class="flex flex-col">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-5">
        ...
        <div class="flex items-center gap-3 mt-3 md:mt-0">
            <!-- Search Form -->
            <form action="<?= BASE_URL ?>/librarian/users" method="GET" class="flex items-center gap-2">
                <div class="relative">
            ...
            <a href="<?= BASE_URL ?>/librarian/users/create" 
            ...
            <table class="user-table">
                <thead>
                    <tr>
                        ...
                        <th>Name</th>
                        <th>Email</th>   <!-- This column will be left-aligned -->
                        <th>Phone</th>
                        <th>Status</th>
                        <th>Registered</th>
                    ...
                    <?php if (!empty($users)): ?>
                        ...
                        <?php foreach ($users as $user): ?>
                            <?php
                                ...
                                $status = $user->getStatus()->getValue() ?? 'pending';
                            ?>
                            <tr>
                                ...
                                <td title="<?= htmlspecialchars($email) ?>">
                                    <?php 
                                    if (strlen($email) > 30) {
                                ...
                                <td class="actions-cell">
                                    <div class="flex items-center justify-center gap-0.5 flex-nowrap">
                                        <!-- View -->
                                        <a href="<?= BASE_URL ?>/librarian/users/view/<?= $user->getId() ?>" 
                                           class="action-btn view" title="View User">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <!-- Edit -->
                                        <a href="<?= BASE_URL ?>/librarian/users/edit/<?= $user->getId() ?>" 
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="7" class="py-12 text-center text-gray-500 dark:text-gray-400">
                                ...
                                <a href="<?= BASE_URL ?>/librarian/users/create" class="mt-3 inline-block bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition">
