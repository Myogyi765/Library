    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <!-- ✅ Add Book -->
                <a href="<?= BASE_URL ?>/librarian/books/create" class="flex flex-col items-center justify-center p-4 rounded-lg bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition text-blue-600 dark:text-blue-400">
                ...
                <!-- ✅ Payments -->
                <a href="<?= BASE_URL ?>/librarian/payments" class="flex flex-col items-center justify-center p-4 rounded-lg bg-green-50 dark:bg-green-900/20 hover:bg-green-100 dark:hover:bg-green-900/30 transition text-green-600 dark:text-green-400">
                    <i class="fas fa-credit-card text-2xl"></i>
                    <span class="mt-1 text-sm font-medium">Payments</span>
                </a>
                                <!-- ✅ Borrowing History (NEW) – Replaces Issue Book -->
                <a href="<?= BASE_URL ?>/librarian/loans" class="flex flex-col items-center justify-center p-4 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 transition text-indigo-600 dark:text-indigo-400">
                    <i class="fas fa-history text-2xl"></i>
                    <span class="mt-1 text-sm font-medium">Borrowing History</span>
                </a>
            </div>
        </div>
        ...
        <?php if (!empty($stats['recentActivities'] ?? [])): ?>
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?= BASE_URL ?>/librarian/loans" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">View All</a>
                </div>
                <div class="space-y-3">
